...
p = {
        "left": "resources/tsukuba_1.png",
        "right": "resources/tsukuba_2.png",
        "sigma_x": 1.,
        "sigma_z": 1.,
...
if __name__ == "__main__":
    ...
    max_translation = get_max_translation(left_img, right_img)
    print("Max translation:", max_translation)

    dm_filtered = disparity_map(left_img,
                                 right_img,
    ...
    d = plot_disparity(left_img, dm_filtered[:, :left_img.shape[1]])
